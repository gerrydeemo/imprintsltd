...
function Contact() {
  ...
  return (
      <div className='bg-black w-screen h-screen overflow-y-scroll xl:overflow-hidden lg:overflow-hidden'>
        <Navbar pageNumber={5}/>
      ...
      <div class="flex flex-wrap lg:justify-between -mx-4 ">
         <motion.div initial={{
                  ...
                  animate={{
                    opacity: 1,
                    x: 0
                  }} class="w-full lg:w-1/2 xl:w-6/12 px-4 shadow-md rounded-2xl shadow-red-900 ">
            <div class="max-w-[570px] mb-12 lg:mb-0">
            
               <h2
                  class="
                  text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-gray-900
               ...
               <p class="text-base text-body-color leading-relaxed mb-9 text-[#2f2f2f]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eius tempor incididunt ut labore et dolore magna aliqua. Ut enim
                  adiqua minim veniam quis nostrud exercitation ullamco
               </p>
               <div class="flex mb-8 max-w-[370px] w-full cursor-pointer">
                  <div
                     class="
                     max-w-[60px]
                     sm:max-w-[70px]
                  ...
                  <div class="w-full ">
                     <h4 class="font-bold text-[#2f2f2f] text-xl mb-1">Our Location</h4>
                     <p class="text-base text-[#2f2f2f]">
                        183 Moss Road, Lisburn
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full cursor-pointer">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-[#2f2f2f] text-xl mb-1">Phone Number</h4>
                     <p class="text-base text-[#2f2f2f]">+44 7889 063140</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full cursor-pointer">
                  <div
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-[#2f2f2f] text-xl mb-1">
                        Email Address
                     </h4>
                     <p class="text-base text-[#2f2f2f]">gordondempsey@hotmail.co.uk</p>
                  </div>
               </div>
            </div>
         </motion.div>
         <motion.div class="w-full mt-20 lg:w-1/2 lg:mt-0 xl:w-5/12 xl:mt-0 px-4" initial={{
            ...
            <div class="bg-gray relative rounded-lg p-8 sm:p-12 shadow-lg ">
               <form>
                  <div class="mb-6">
                     <input
                        type="text"
